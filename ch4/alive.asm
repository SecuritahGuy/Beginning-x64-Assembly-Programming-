;alive.asm
BITS 64;used for the syntax highlight
section .data 
...
main:
    ...
    mov rdx,msg1Len ;length of string 1
    syscall         ;display the string 
    mov rax,1       ;1 = write
    mov rdi,1       ;1 = stdout
    mov rsi,msg2    ;string to display
    mov rdx,msg2Len ;length of message 2
    syscall         ;display string to console
    mov rsp,rbp     ;function epilogue
    pop rbp         ;function epilogue
    mov rax,60      ;exit code
    mov rdi,0       ;successful exit code
    syscall
